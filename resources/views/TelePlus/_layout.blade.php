      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav mx-auto">
            ...
            <li class="nav-item <?php echo ends_with(url()->current(),"/about")?"active":"" ?> px-lg-4">
              <a class="nav-link text-uppercase text-expanded" href="/casual/about">About</a>
            </li>
            <li class="nav-item {{ends_with(url()->current(),"/products")?"active":""}} px-lg-4">
              <a class="nav-link text-uppercase text-expanded" href="/casual/products">Products</a>
            </li>
            <li class="nav-item {{ends_with(url()->current(),"/store")?"active":""}} px-lg-4">
              <a class="nav-link text-uppercase text-expanded" href="/casual/store">Store</a>
            </li>
          </ul>
        </div>
      </div>
